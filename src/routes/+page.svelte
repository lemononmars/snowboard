<script>
   ...
   const games = [
      ...
      },
      {
         ...
         numPlayers: '2-6',
         time: '60-90',
         mechanics: ['Grid movement', 'Action selection', 'Set collection', 'Multiplayer'],
         description: `Multiplayer online board game of Pak Klong Talat`
      },
      {
         title: 'Space Spy',
   ...
   function joinLobby(link){
      if (link.endsWith('.html') || link.startsWith('/p/')) {
